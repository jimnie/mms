package com.educonsulting.mms.activemq.topic;
...
//    public static final String BROKER_URL = ActiveMQConnection.DEFAULT_BROKER_URL;
    public static final String BROKER_URL = "tcp://192.168.2.11:61616";
    /**
     * 队列名称
     */
    public static final String TOPIC_NAME = "bizInfTopic";
    ...
    public void doSend() {
        try {
             ...
             */
//            TextMessage message = session.createTextMessage("send topic content");

            MapMessage message = session.createMapMessage();
            // 业务编号
            message.setStringProperty("biz_num", "20191209001");
            // 逝者信息
            message.setStringProperty("ds_id_card", "120102195005011071");
            message.setStringProperty("ds_name", "张二");
            ...
            message.setStringProperty("tel", "15822002211");
            message.setStringProperty("addr", "天津市北辰区铁东北路5998号");
