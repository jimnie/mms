...
public class CRC16 {
     ...
     * @since 1.0
     */
    public static String getCrc3(byte[] bytes) {
        //CRC寄存器全为1
        int CRC = 0x0000ffff;
        //多项式校验值
        int POLYNOMIAL = 0x0000a001;
     ...
     * 计算CRC16校验码
     *
     * @param data 需要校验的字符串，例如 01 03 00 00 00 08 44 0C
     * @return 校验码
     */
...
//        System.out.println(getCrc("01 03 10 00 8F 02 4E 00 91 02 44 00 92 02 5A 00 8B 02 47"));
        // 01 10 20 00 00 01 02 00 01 46 52
//        byte[] b = new byte[]{0x01, 0x10, 0x20, 0x00, 0x00, 0x01, 0x02, 0x00, 0x01};
//        byte[] crc16 = AGVUtil.hexStringToBytes(getCrc2(b));
//        byte[] allBytes = AGVUtil.byteMergerAll(b, crc16);
//        System.out.println(AGVUtil.printHexString(allBytes));
        System.out.println(CRC16.getCrc("01 10 02 01 00 01 02 00 02"));
    }
}