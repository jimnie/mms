...
import com.educonsulting.mms.EnumConverter;
import com.educonsulting.mms.Setting;
    ...
    static {
        ConvertUtilsBean convertUtilsBean = new ConvertUtilsBean() {
                ...
                if (value != null) {
                    ...
                    if (type.isEnum() && super.lookup(type) == null) {
                        ...
                        if (super.lookup(type) == null) {
                            ArrayConverter arrayConverter = new ArrayConverter(type, new
                                    EnumConverter(type.getComponentType()), 0);
            ...
            public Object convert(String[] values, Class clazz) {
                if (clazz.isArray() && clazz.getComponentType().isEnum() && super.lookup(clazz
                        .getComponentType()) == null) {
                    super.register(new EnumConverter(clazz.getComponentType()), clazz
                            .getComponentType());
                }
            ...
            public Object convert(Object value, Class targetType) {
                if (super.lookup(targetType) == null) {
                    if (targetType.isEnum()) {
                        ...
                        ArrayConverter arrayConverter = new ArrayConverter(targetType, new
                                EnumConverter(targetType.getComponentType()), 0);
                        arrayConverter.setOnlyFirstToString(false);
    ...
    public static Setting get() {
        ...
        if (cacheElement != null) {
            ...
            try {
                ...
                List<Element> elements = document.selectNodes(CommonAttributes.SETTING_NODE_PATH);
