...
public class Constants {
    ...
    public static final String JASPER_FILE_PATH = "WEB-INF\\jasper\\";

    public static final String GENERATE_PDF_PATH = "pdf\\";

    public static final String GENERATE_PIC_PATH = "sign\\";
