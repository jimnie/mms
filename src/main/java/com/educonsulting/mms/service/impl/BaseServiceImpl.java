...
import com.educonsulting.mms.service.BaseService;
...
public class BaseServiceImpl<T, ID extends Serializable> implements BaseService<T, ID> {
    ...
    private static final String[] UPDATE_IGNORE_PROPERTIES = new String[]{BaseEntity
            .ID_PROPERTY_NAME, BaseEntity.CREATE_DATE_PROPERTY_NAME, BaseEntity
    ...
    public T update(T entity, String... ignoreProperties) {
        ...
        if (persistant != null) {
            copyProperties(entity, persistant, (String[]) ArrayUtils.addAll(ignoreProperties,
                    UPDATE_IGNORE_PROPERTIES));
    ...
    private void copyProperties(Object source, Object target, String[] ignoreProperties) throws
            BeansException {
        ...
        for (PropertyDescriptor targetPd : targetPds) {
            if (targetPd.getWriteMethod() != null && (ignoreProperties == null || (!ignoreList
                ...
                if (sourcePd != null && sourcePd.getReadMethod() != null) {
                    try {
                        ...
                        if (sourceValue != null && targetValue != null && targetValue instanceof
                                Collection) {
