...
import com.educonsulting.mms.entity.OrderEntity;
...
public abstract class ViewBaseDaoImpl<T extends Serializable> implements ViewBaseDao<T> {
        ...
        for (Filter filter : filters) {
            ...
            if (filter.getOperator() == Filter.Operator.eq && filter.getValue() != null) {
                ...
                restrictions = criteriaBuilder.and(restrictions, criteriaBuilder.le(root
                        .<Number>get(filter.getProperty()), (Number) filter.getValue()));
            } else if (filter.getOperator() == Filter.Operator.like && filter.getValue() != null &&
