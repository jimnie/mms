package com.rcbank.mms.aspect;

import com.rcbank.mms.annotation.SystemControllerLog;
import com.rcbank.mms.annotation.SystemServiceLog;
...
public class SystemLogAspect {
    ...
    //Service层切点
    @Pointcut("@annotation(com.rcbank.mms.annotation.SystemServiceLog)")
    public void serviceAspect() {
    }

    //Controller层切点
    @Pointcut("@annotation(com.rcbank.mms.annotation.SystemControllerLog)")
...
//            log.setMethod((joinPoint.getTarget().getClass().getName() + "." + joinPoint
