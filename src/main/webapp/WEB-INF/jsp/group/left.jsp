...
<HEAD>
    ...
    <link rel="stylesheet" href="<c:url value="/tg/commons/easyui/themes/default/easyui.css"/>"
          type="text/css"/>
    <link rel="stylesheet" href="<c:url value="/tg/commons/easyui/themes/icon.css"/>"
          type="text/css"/>
