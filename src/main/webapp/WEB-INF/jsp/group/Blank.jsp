...
<div class="easyui-layout" fit="true">
    <div region="north" border="false">
        <div class="toolbar">
            ...
            <a href="#" class="easyui-linkbutton" plain="true" onclick="addRoleItem()">组授权角色</a>
...
<div id="rolGroup" style="width:250px;height:600px;" class="easyui-dialog" closed="true"
     modal="true"
...
<div id="adduser" style="width:400px;height:600px;" class="easyui-dialog" closed="true" modal="true"
     buttons="#dlg-buttons">
            ...
            <form id="myform" method="post" style="margin:0;padding:0">
                <table>
                    <tr>
                        ...
                        <td><input type="text" id="name" class="easyui-validatebox e-input"
                                   name="group.name"
                    ...
                    <tr>
                        <td>组类别</td>
                        <td>
                            <input type="text" id="grouptype" class="e-input"
                    ...
                    <tr>
                        <td>所属组</td>
                        <td>
                            <input id="parentId" name="group.parentId" class="easyui-combobox"
                                   style="width:200px"
                                   url="<c:url value="/group/allGroup.tg"/>" valueField="id"
                    ...
                    <tr>
                        <td>状态</td>
                        <td>
                            <select class="easyui-combobox" id="status" name="group.status"
                                    panelHeight="60"
                                    style="width:60px">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="orderid" class="e-input"
                                   name="group.orderId"></input></td>
                    </tr>
                    <tr>
                        <td>备注</td>
                        <td><input type="text" id="memo" class="e-input" name="group.memo"></input>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
...
<div id="look" style="width:600px;height:400px;"
        ...
        <div style="float:center">
            <form id="myform" method="post" style="margin:0;padding:0">
                <table>
                    <tr>
                        <td style="width:80px">组名称</td>
                        <td><input readonly type="text" id="lname"
                                   class="easyui-validatebox e-input" name="group.name"
                                   required="true"></input></td>
                    </tr>
                    <tr>
                        <td>组英文名称</td>
                        <td>
                            <input readonly type="text" id="lenname" class="e-input"
                                   name="group.enName">
                        </td>
                    </tr>
                    <tr>
                        <td>组类别</td>
                        <td>
                            <input readonly type="text" id="lgrouptype" class="e-input"
                                   name="group.groupType">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>状态</td>
                        <td>
                            <input readonly type="text" id="lstatus" class="e-input"
                                   name="group.parentId">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>排序</td>
                        <td><input readonly type="text" id="lorderid" class="e-input"
                                   name="group.orderId"></input></td>
                    </tr>
                    <tr>
                        <td>备注</td>
                        <td><input readonly type="text" id="lmemo" class="e-input"
                                   name="group.memo"></input></td>
                    </tr>
                </table>
            </form>
        </div>
    ...
    <div id="dlg-buttons" style="text-align:center;">
        <a href="#" class="easyui-linkbutton" iconCls="icon-cancel"
           onclick="javascript:$('#look').dialog('close')">关闭</a>
    </div>
</div>
